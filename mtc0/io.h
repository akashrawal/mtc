/* io.h
 * IO over file descriptors with state saving
 * 
...
//A large part of this file is private to the library. 

/**
 * \addtogroup mtc_io
 * \{
 * 
 * This section documents IO and file descriptor related
 * definitions in MTC Lowlevel.
 */
